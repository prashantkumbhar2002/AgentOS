...
- 5 user stories cover the full scope: login, protected access, RBAC, token refresh, seed data.
...
- Out of Scope section explicitly excludes OAuth, password reset, email verification, multi-tenancy, and 2FA.
